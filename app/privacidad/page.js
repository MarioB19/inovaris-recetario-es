export const metadata = {
  ...
  description: "Política de privacidad de Inovaris y del sitio recetario-es.inovaris.online.",
  robots: { index: false },
};
  ...
  return (
    <main className="max-w-3xl mx-auto px-5 py-14 font-sans text-gray-700 leading-relaxed">
      ...
      <p>
        ...
        recetario digital &quot;Recetas que Sí Puedo Comer&quot;.
      </p>
      ...
      <p>
        Las compras se procesan a través de <strong>Gumroad</strong> (gumroad.com), que actúa como
        comerciante de registro. Inovaris no recibe ni almacena los datos de tu tarjeta. El
        tratamiento de tus datos de pago se rige por la política de privacidad de Gumroad,
        disponible en gumroad.com/privacy. El cargo se procesa en dólares estadounidenses (USD).
      </p>
      ...
      <p>
        ...
        operar: la plataforma de pago (Gumroad), servicios de análisis y publicidad (Meta) y el
