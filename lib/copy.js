...
export const copy = {
  ...
  finalCta: {
    headline: "Pruébalo sin riesgo durante 7 días",
    guaranteeText:
      "Tu compra está protegida por la garantía de satisfacción de 7 días de Hotmart. Si el recetario no es para ti, escribes y te devuelven tu dinero. Sin complicaciones.",
    bundleList: [
  ...
  faq: {
    ...
    items: [
      {
        q: "¿Cómo lo recibo?",
        a: "Al instante: tras tu compra llega a tu correo y al área de miembros de Hotmart, en PDF, para descargar en el celular o la computadora.",
      },
      {
  ...
  closing: {
    ...
    reassurance: "Entrega inmediata · garantía de 7 días · pago seguro",
  },
